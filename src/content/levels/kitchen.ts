...
export const KITCHEN_3: LevelDef = {
  ...
  waves: [
    ...
    { entries: [e('roach', 3, 3.5, 'drain'), e('ant-soldier', 3, 3, 'door', 5)] },
    { entries: [e('ant-worker', 16, 0.55, 'door'), e('fly-fruit', 12, 0.4, 'drain', 6)] },
    { entries: [e('roach', 4, 3, 'drain'), e('moth', 5, 1.8, 'door', 4), e('ant-bullet', 7, 1.1, 'door', 8)] },
    { entries: [e('ant-soldier', 5, 2.4, 'door'), e('roach', 3, 3.5, 'drain', 6), e('fly-house', 5, 1.9, 'door', 10)] },
    { entries: [e('roach', 6, 2.2, 'drain'), e('ant-worker', 18, 0.5, 'door', 4), e('moth', 7, 1.4, 'door', 12)] },
  ],
  mutationWaves: [3, 6],
  tutorial: [
...
export const KITCHEN_4: LevelDef = {
  ...
  waves: [
    ...
    { entries: [e('snail', 3, 4, 'crack'), e('moth', 6, 1.5, 'window', 3), e('ant-bullet', 8, 1.05, 'door', 6)] },
    { entries: [e('mouse-thief', 2, 8, 'door'), e('roach', 5, 2.5, 'door', 4), e('slug', 5, 2.3, 'crack', 8), e('fly-house', 6, 1.7, 'window', 10)] },
  ],
  mutationWaves: [3, 6],
  tutorial: [
...
export const KITCHEN_5: LevelDef = {
  ...
  clutterPerWave: 4,
  waves: [
    { entries: [e('ant-worker', 10, 0.85, 'door'), e('ant-bullet', 3, 2.2, 'vent', 6)] },
