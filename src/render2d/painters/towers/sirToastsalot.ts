/**
 * PAINTER - Sir Toastsalot (id 'sir-toastsalot'). noble toaster mortar.
...
registerTowerPainter('sir-toastsalot', (ctx, size, _frame, opts) => {
  ...
  roundRect(x + w + size * 0.015, y + size * 0.12, size * 0.055, size * 0.19, size * 0.02);
  ...
  drawPips(size * 0.86);
  ascendRect(x - ink, size * 0.15, w + ink * 2, h + size * 0.12, size * 0.13, y + h * 0.45);
