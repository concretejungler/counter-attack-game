...
const PAR: Record<string, Step[]> = {
  ...
  'bedroom-1': [
    ...
    { wave: 3, clutter: [[1, 3, 1]], towers: [['old-smacky', 1, 3, 1]] },
    { wave: 4, clutter: [[2, 1, 2]], towers: [['bandolero', 2, 1, 2]] },
  ],
  'bedroom-2': [
    ...
    { wave: 3, clutter: [[1, 2, 2]], towers: [['bandolero', 1, 2, 2]] },
    { wave: 4, clutter: [[2, 1, 1]], towers: [['sir-toastsalot', 2, 1, 1]] },
    { wave: 6, towers: [['gnomeo', 13, 8]] },
  ],
  'bedroom-3': [
    ...
    { wave: 3, clutter: [[3, 1, 2]], towers: [['bandolero', 3, 1, 2]] },
    { wave: 4, clutter: [[1, 2, 1]], towers: [['the-coldfather', 1, 2, 1], ['lux-interior', 1, 2, 1]] },
    { wave: 6, towers: [['gnomeo', 12, 8]] },
    { wave: 7, clutter: [[7, 2, 1]], towers: [['old-smacky', 7, 2, 1]] },
  ],
  'bedroom-4': [
    ...
    { wave: 3, clutter: [[4, 1, 2]], towers: [['bandolero', 4, 1, 2]] },
    { wave: 4, clutter: [[2, 2, 1]], towers: [['the-coldfather', 2, 2, 1], ['lux-interior', 2, 2, 1]] },
    { wave: 6, towers: [['gnomeo', 12, 8]] },
    { wave: 8, clutter: [[8, 2, 1]], towers: [['old-smacky', 8, 2, 1], ['sgt-spritz', 8, 2, 1]] },
  ],
  ...
  'garage-1': [
    ...
    { wave: 3, clutter: [[1, 2, 2]], towers: [['static', 1, 2, 2]] },
  ...
  'garage-2': [
    ...
    { wave: 3, clutter: [[2, 2, 2]], towers: [['static', 2, 2, 2]] },
    { wave: 4, clutter: [[1, 1, 1]], towers: [['the-coldfather', 1, 1, 1], ['stick-rick', 8, 5], ['stick-rick', 10, 5]] },
  ...
  'garage-3': [
    ...
    { wave: 3, clutter: [[1, 2, 2]], towers: [['static', 1, 2, 2]] },
    { wave: 4, clutter: [[6, 2, 1]], towers: [['the-coldfather', 6, 2, 1]] },
  ...
  'garage-4': [
    ...
    { wave: 3, clutter: [[1, 2, 3]], towers: [['static', 1, 2, 3]] },
    { wave: 4, clutter: [[10, 2, 1]], towers: [['the-coldfather', 10, 2, 1]] },
  ...
  'garage-5': [
    ...
    { wave: 3, clutter: [[4, 1, 2]], towers: [['static', 4, 1, 2]] },
    { wave: 4, clutter: [[8, 2, 1]], towers: [['the-coldfather', 8, 2, 1]] },
    { wave: 6, towers: [['gnomeo', 12, 8]] },
    { wave: 8, clutter: [[5, 1, 2]], towers: [['mike-rowave', 5, 1, 2], ['bandolero', 5, 1, 2]] },
    { wave: 10, clutter: [[1, 1, 2]], towers: [['static', 1, 1, 2], ['dj-decibel', 1, 1, 2]] },
  ],
};

const OPENING: Record<string, Step> = {
  'living-1': { wave: 0, clutter: [[4, 6], [10, 6], [3, 1, 1]], towers: [['professor-scorch', 4, 6], ['professor-scorch', 10, 6], ['professor-scorch', 3, 1, 1]] },
  'living-2': { wave: 0, clutter: [[3, 3], [10, 3], [3, 1, 1]], towers: [['professor-scorch', 3, 3], ['professor-scorch', 10, 3], ['professor-scorch', 3, 1, 1]] },
  'living-3': { wave: 0, clutter: [[4, 7], [6, 7], [8, 7], [10, 7], [12, 6]], towers: [['professor-scorch', 4, 7], ['professor-scorch', 6, 7], ['professor-scorch', 8, 7], ['professor-scorch', 10, 7], ['professor-scorch', 12, 6]] },
  'living-4': { wave: 0, clutter: [[2, 5], [11, 5], [2, 0, 3]], towers: [['professor-scorch', 2, 5], ['professor-scorch', 11, 5], ['professor-scorch', 2, 0, 3]] },
  'living-5': { wave: 0, clutter: [[3, 7], [5, 7], [7, 7], [9, 7], [11, 7]], towers: [['professor-scorch', 3, 7], ['professor-scorch', 5, 7], ['professor-scorch', 7, 7], ['professor-scorch', 9, 7], ['professor-scorch', 11, 7]] },
  ...
  'bedroom-1': { wave: 0, clutter: [[3, 7], [11, 7], [4, 1, 1]], towers: [['professor-scorch', 3, 7], ['professor-scorch', 11, 7], ['professor-scorch', 4, 1, 1]] },
  'bedroom-2': { wave: 0, clutter: [[2, 5], [13, 7], [3, 2, 2]], towers: [['professor-scorch', 2, 5], ['professor-scorch', 13, 7], ['professor-scorch', 3, 2, 2]] },
  'bedroom-3': { wave: 0, clutter: [[4, 7], [12, 7], [2, 1, 2]], towers: [['professor-scorch', 4, 7], ['professor-scorch', 12, 7], ['professor-scorch', 2, 1, 2]] },
  'bedroom-4': { wave: 0, clutter: [[3, 7], [12, 7], [3, 1, 2]], towers: [['professor-scorch', 3, 7], ['professor-scorch', 12, 7], ['professor-scorch', 3, 1, 2]] },

  'garage-1': { wave: 0, clutter: [[4, 6], [12, 6], [5, 1, 1], [1, 1, 2]], towers: [['professor-scorch', 4, 6], ['professor-scorch', 12, 6], ['professor-scorch', 5, 1, 1], ['professor-scorch', 1, 1, 2]] },
  'garage-2': { wave: 0, clutter: [[3, 5], [5, 5], [8, 5], [10, 5], [12, 5]], towers: [['professor-scorch', 3, 5], ['professor-scorch', 5, 5], ['sir-toastsalot', 8, 5], ['sir-toastsalot', 10, 5], ['professor-scorch', 12, 5]] },
  'garage-3': { wave: 0, clutter: [[4, 7], [16, 4], [3, 1, 2], [5, 1, 1]], towers: [['professor-scorch', 4, 7], ['professor-scorch', 16, 4], ['professor-scorch', 3, 1, 2], ['professor-scorch', 5, 1, 1]] },
  'garage-4': { wave: 0, clutter: [[1, 6], [13, 6], [3, 1, 3], [5, 1, 2]], towers: [['professor-scorch', 1, 6], ['professor-scorch', 13, 6], ['professor-scorch', 3, 1, 3], ['professor-scorch', 5, 1, 2]] },
  'garage-5': { wave: 0, clutter: [[3, 8], [12, 8], [3, 1, 2], [5, 1, 1]], towers: [['professor-scorch', 3, 8], ['professor-scorch', 12, 8], ['professor-scorch', 3, 1, 2], ['professor-scorch', 5, 1, 1]] },
};
